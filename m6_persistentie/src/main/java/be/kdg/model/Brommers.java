...
import java.util.*;
public class Brommers implements Serializable {
    @Serial
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof Brommers brommers1)) return false;
        return Objects.equals(getBrommers(), brommers1.getBrommers());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getBrommers());
    }
}
