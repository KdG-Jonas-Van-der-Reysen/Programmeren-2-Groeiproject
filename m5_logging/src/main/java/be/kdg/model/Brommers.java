...
public class Brommers {
    // Logger
    private static final Logger logger = Logger.getLogger("be.kdg.model.Brommers");
    ...
    public boolean add(Brommer brommer) {
        logger.finer("Brommer " + brommer.getModel() + " toegevoegd aan treeset");
        return brommers.add(brommer);
    }

    // Remove
    public boolean remove(Brommer brommer) {
        logger.finer("Brommer " + brommer.getModel() + " verwijderd uit treeset");
